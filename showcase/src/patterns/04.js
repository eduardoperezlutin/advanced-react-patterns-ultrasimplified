import React, { useState, useCallback, useLayoutEffect, createContext, useMemo, useContext, useRef, useEffect } from 'react';
...
/**
 * Context for sub-components tree
 */
...
const ClapCount = ({ style: userStyles = {}, className }) => {
  ...
  return <span ref={setRef} data-refkey='countRef' className={classNames} style={userStyles}>
    + {count}
  </span>
}
...
const CountTotal = ({ style: userStyles = {}, className }) => {
  ...
  return <span ref={setRef} data-refkey='totalCountRef' className={classNames} style={userStyles}>
    {countTotal}
  </span>
}

/**
 * Set subcomponents into MediumClap
 */
...
const Usage = () => {
  ...
  return <div style={{ width: '100%' }} className={userCustomStyles.clap}>
